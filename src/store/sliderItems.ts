export const sliderItems = [
  ...
  },
  {
    id: 2,
    title:
      "В нашем магазине Вы можете приобрести шины и диски от лучших производителей в мире",
    pathImg:
  ...
  },
  {
    id: 5,
    title:
      "Не нашли нужный товар на сайте? Свяжитесь с нами напрямую, и мы поможем с подбором!",
    pathImg:
